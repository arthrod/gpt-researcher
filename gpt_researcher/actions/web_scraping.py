...
async def scrape_urls(
    urls, cfg: Config, worker_pool: WorkerPool, **kwargs
    ...
    try:
        # Pass kwargs to Scraper to support API key passing
        scraper = Scraper(urls, user_agent, cfg.scraper, worker_pool=worker_pool, **kwargs)
